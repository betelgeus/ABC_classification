...
DOWNLOAD_DIR_3 = os.path.abspath(global_config.TEST_DOWNLOAD_DIR_3)
image_path_3 = os.path.join(DOWNLOAD_DIR_3, "1690920920325.png")
...
def test_upload_image():
    ...
    try:
        ...
        with open(image_path_3, "rb") as file_handle:
